...
test("avenger text input", async() => {
  const TEXT = "avengers infinity war";
  await driver.elementByAccessibilityId("avengers").type(TEXT);
  const resultText = await driver.elementByAccessibilityId("avengers").text();
